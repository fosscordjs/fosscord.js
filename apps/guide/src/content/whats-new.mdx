...
<DiscordMessages rounded>
	...
	>
		spacebar.js v14 has released and the guide has been updated!
		<br />
...
- New theme made to match the [spacebar.js documentation site](https://spacebar.js.org/)
...
All content has been updated to use spacebar.js v14 syntax. The v13 version of the guide can be found at [https://v13.discordjs.guide/](https://v13.discordjs.guide/).

### New

- [Updating from v13 to v14](/additional-info/changes-in-v14.md): A list of the changes from spacebar.js v13 to v14
...
- [Voice](/voice/): Rewritten to use the [_`@discordjs/voice`_](https://github.com/spacebarjs/spacebar.js/tree/main/packages/voice) package
...
<DiscordMessages rounded>
	...
	>
		Thank you to all of those that contributed to the development of spacebar.js and the guide!
	</DiscordMessage>
</DiscordMessages>
